...
async def play(ctx, *args):
    ...
    abssa =  FFmpegPCMAudio(filename, executable='C:/Users/ivany/Desktop/Discord_bot/ffmpeg')
    vc.play(abssa)
...
async def play_radio(ctx, r_name):
    ...
    if r_name in data:
        abssa = FFmpegPCMAudio(data[r_name], executable='C:/Users/ivany/Desktop/Discord_bot/ffmpeg')
        vc.play(abssa)
